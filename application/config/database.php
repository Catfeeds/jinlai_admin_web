...
$db['development'] = array(
    'dsn' => 'mysqli://jinlai_admin:Yibang2017@rm-8vb342181z70ol0xy.mysql.zhangbei.rds.aliyuncs.com/jinlai',
    'hostname' => 'rm-8vb342181z70ol0xy.mysql.zhangbei.rds.aliyuncs.com', // 数据库URL，以阿里云为例
    'username' => 'jinlai_admin', // 数据库用户名
    'password' => 'Yibang2017', // 数据库密码
    'database' => 'jinlai', //数据库名
    'dbdriver' => 'mysqli',
    'dbprefix' => '',
