...
<div id=content class=container>
	...
	<?php if ( !empty($operation) ): ?>
		...
		<li class="col-xs-12 col-sm-6 col-sm-3"><a class="btn btn-default btn-lg" title="继续创建" href="<?php echo base_url($this->class_name.'/create?vote_id='.$vote_id) ?>">继续创建</a></li>
		
		<?php elseif ( in_array($operation, array('create', 'edit', 'edit_certain',)) ): ?>
