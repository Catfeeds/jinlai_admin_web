	...
	?>
        ...
        <fieldset>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=url_video type=text value="<?php echo set_value('url_video') ?>" placeholder="形象视频URL" required>
				</div>
			</div>
			<div class=form-group>
				<label for=url_audio class="col-sm-2 control-label">背景音乐URL</label>
				<div class=col-sm-10>
					<input class=form-control name=url_audio type=text value="<?php echo set_value('url_audio') ?>" placeholder="背景音乐URL" required>
				</div>
			</div>
			-->
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=url_name type=text value="<?php echo set_value('url_name') ?>" placeholder="URL名称" required>
				</div>
			</div>
			<div class=form-group>
				<label for=signup_allowed class="col-sm-2 control-label">可报名</label>
				<div class=col-sm-10>
					<input class=form-control name=signup_allowed type=text value="<?php echo set_value('signup_allowed') ?>" placeholder="可报名" required>
				</div>
			</div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=max_user_total type=number min=0 max=999 step=1 value="<?php echo set_value('max_user_total') ?>" placeholder="每选民最高总选票数" required>
				</div>
			</div>
			<div class=form-group>
				<label for=max_user_daily class="col-sm-2 control-label">每选民最高日选票数</label>
				<div class=col-sm-10>
					<input class=form-control name=max_user_daily type=number min=1 max=99 step=1 value="<?php echo set_value('max_user_daily') ?>" placeholder="每选民最高日选票数" required>
				</div>
			</div>
			<div class=form-group>
				<label for=max_user_daily_each class="col-sm-2 control-label">每选民同选项最高日选票数</label>
				<div class=col-sm-10>
					<input class=form-control name=max_user_daily_each type=number min=1 max=99 step=1 value="<?php echo set_value('max_user_daily_each') ?>" placeholder="每选民同选项最高日选票数" required>
				</div>
			</div>
			<div class=form-group>
