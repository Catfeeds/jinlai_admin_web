	...
	?>
		...
		<fieldset>
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=article_id type=text value="<?php echo set_value('article_id') ?>" placeholder="相关文章ID">
				</div>
			</div>
			<div class=form-group>
				<label for=receiver_type class="col-sm-2 control-label">收信端类型</label>
				<div class=col-sm-10>
					<input class=form-control name=receiver_type type=text value="<?php echo set_value('receiver_type') ?>" placeholder="收信端类型">
				</div>
			</div>
			<div class=form-group>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<textarea class=form-control name=excerpt rows=5 placeholder="摘要"><?php echo set_value('excerpt') ?></textarea>
				</div>
			</div>
			<div class=form-group>
