	...
	?>
        ...
        <fieldset>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=time_start type=datetime value="<?php echo (empty($item['time_start']) || $item['time_start'] < time())? NULL: date('Y-m-d H:i', $item['time_start']); ?>" placeholder="例如：<?php echo date('Y-m-d H:i', strtotime('+1days')) ?>；留空则马上开放领取">
