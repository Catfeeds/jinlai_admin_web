	...
	?>
        ...
        <fieldset>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=time_start type=datetime value="<?php echo set_value('time_start') ?>" placeholder="例如：<?php echo date('Y-m-d H:i', strtotime('+1days')) ?>；留空则马上开放领取">
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=time_end type=datetime value="<?php echo set_value('time_end') ?>" placeholder="例如：<?php echo date('Y-m-d H:i', strtotime('+31days')) ?>；留空则长期有效">
