...
.menuSearchList .iconSanjiao:before{
    content: "\e9bc";
    position: absolute;
    top: -0.42rem;
    right: 0;
...
.thisList{
    width: 100%;
    height: 100%;
    background-color: rgba(0, 0, 0, 0);position: fixed;
    z-index: 10000;
    font-size: 0.28rem;
    display: none;
}
        ...
        <div class="tabcontent" id="listMenu">
            <div class="item" style="display: block;">
                ...
                <div class="menuWrap auto clearfix swiper-slide">
                    <ul class="clearfix">
                        <li>
                            <a href="<?php echo base_url('page/tabdetail?id=834') ?>" target=_self>
                                <div class="iconWrap">
                                    <img data-src="/media/images/service/学习教育.png">
                                </div>
                                <span class="text">学习教育</span>
                            </a>
                        </li>
                        <li>
                             <a href="<?php echo base_url('page/tabdetail?id=510') ?>" target=_self>
                                <div class="iconWrap4">
                                    <img data-src="/media/images/service/休闲娱乐.png">
                                </div>
                                <span class="text">休闲娱乐</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('page/tabdetail?id=513') ?>" target=_self>
                                <div class="iconWrap3">
                                    <img data-src="/media/images/service/时尚丽人.png">
                                </div>
                                <span class="text">时尚丽人</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('page/tabdetail?id=515') ?>" target=_self>
                                <div class="iconWrap4">
                                    <img data-src="/media/images/service/宠物服务@3x.png">
                                </div>
                                <span class="text">宠物服务</span>
                            </a>
                        </li>
                        <li style="margin-right:0">
                            <a href="<?php echo base_url('page/tabdetail?id=516') ?>" target=_self>
                                <div class="iconWrap5">
                                    <img data-src="/media/images/service/旅游民宿@3x.png">
                                </div>
                                <span class="text">旅游民宿</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('page/tabdetail?id=512') ?>" target=_self>
                                <div class="iconWrap">
                                    <img data-src="/media/images/service/运动健康.png">
                                </div>
                                <span class="text">运动健康</span>
                            </a>
                        </li>
                        <li>
                             <a href="<?php echo base_url('page/tabdetail?id=514') ?>" target=_self>
                                <div class="iconWrap4">
                                    <img data-src="/media/images/service/婚纱摄影@3x.png">
                                </div>
                                <span class="text">婚纱摄影</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('page/tabdetail?id=517') ?>" target=_self>
                                <div class="iconWrap3">
                                    <img data-src="/media/images/service/汽车管家.png">
                                </div>
                                <span class="text">汽车管家</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('page/tabdetail?id=511') ?>" target=_self>
                                <div class="iconWrap4">
                                    <img data-src="/media/images/service/特色美食.png">
                                </div>
                                <span class="text">特色美食</span>
                            </a>
                        </li>
                        <li style="margin-right:0">
                            <a href="<?php echo base_url('page/tabdetail?id=518') ?>" target=_self>
                                <div class="iconWrap5">
                                    <img data-src="/media/images/service/私人定制.png">
                                </div>
                ...
                <div class="newgoodslist auto clearfix">
                    <div class="twocol clearfix">
                        <div class="goodsleft">
                            <ul class="clearfix">
                                <li style="width: 100%;">
                                    <a href="<?php echo $part9['businesslist']['business']['defaultlist']['default'][0]['link'] ?>" target="_self">
                                    <div class="pic" style="margin: 0 auto;width:100%;">
                                        <img src="<?php echo $part9['businesslist']['business']['defaultlist']['default'][0]['cimgurl'] ?>" style="width: auto;display:inline-block;">
                                    </div>
                                    </a>
                                    <p><?php echo $part9['businesslist']['business']['defaultlist']['default'][0]['title'] ?></p>
                                    <span><?php echo $part9['businesslist']['business']['defaultlist']['default'][0]['price'] ?></span>
                                </li>
                            </ul>
                        </div>
                        <div class="goodsleft" style="margin-left:.1rem">
                            <ul class="clearfix">
                                <li style="width: 100%;">
                                    <a href="<?php echo $part9['businesslist']['business']['defaultlist']['default'][1]['link'] ?>" target="_self">
                                    <div class="pic" style="margin: 0 auto;width:100%;">
                                        <img src="<?php echo $part9['businesslist']['business']['defaultlist']['default'][1]['cimgurl'] ?>"  style="width: auto;display:inline-block;">
                                    </div>
                                    </a>
                                    <p><?php echo $part9['businesslist']['business']['defaultlist']['default'][1]['title'] ?></p>
                                    <span><?php echo $part9['businesslist']['business']['defaultlist']['default'][1]['price'] ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="threecol">
                        <ul>
                            <li>
                                <a href="<?php echo $part9['businesslist']['business']['defaultlist']['default'][2]['link'] ?>" target="_self">
                                <div class="pic">
                                    <img data-src="<?php echo $part9['businesslist']['business']['defaultlist']['default'][2]['cimgurl'] ?>">
                                </div>
                                </a>
                                <p><?php echo $part9['businesslist']['business']['defaultlist']['default'][2]['title'] ?></p>
                                <span><?php echo $part9['businesslist']['business']['defaultlist']['default'][2]['price'] ?></span>
                            </li>
                            <li>
                                <a href="<?php echo $part9['businesslist']['business']['defaultlist']['default'][3]['link'] ?>" target="_self">
                                <div class="pic">
                                    <img data-src="<?php echo $part9['businesslist']['business']['defaultlist']['default'][3]['cimgurl'] ?>">
                                </div>
                                </a>
                                <p><?php echo $part9['businesslist']['business']['defaultlist']['default'][3]['title'] ?></p>
                                <span><?php echo $part9['businesslist']['business']['defaultlist']['default'][3]['price'] ?></span>
                            </li>
                            <li style="margin-right:0">
                                <a href="<?php echo $part9['businesslist']['business']['defaultlist']['default'][4]['link'] ?>" target="_self">
                                <div class="pic">
                                    <img data-src="<?php echo $part9['businesslist']['business']['defaultlist']['default'][4]['cimgurl'] ?>">
                                </div>
                                </a>
                                <p><?php echo $part9['businesslist']['business']['defaultlist']['default'][4]['title'] ?></p>
                                <span><?php echo $part9['businesslist']['business']['defaultlist']['default'][4]['price'] ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
...
?>
    ...
    <div id="itemIndexSearch" style="display:none;padding:.1rem .4rem;position:fixed;width:100%;height:100%;background:#fff;top:0px;left:0px;z-index:999999">
   ...
   <div class="bussinesswrap clearfix" style="background:#eaeaea;display: none;position: absolute;top:0px;left:0px;z-index: 99999;overflow: scroll;height:100%">
    <!--店家商品分类导航条-->
    <div class="shopTitle">
            ...
            <div class="shopSearch fl" style="background: transparent;">
                <input type="search" placeholder="搜索感兴趣的内容" id="biz_search">
                <i class="icon-搜索"></i>
            </div>
            ...
            <div id="menuSearch" class="biz_dot fl">
                <ul>
                    <li></li>
                    <li></li>
                    <li></li>
                    ...
                    <ul class="menuSearchList menuListActive" style="position: fixed;">
                        <li>
                            <a title="首页" href="<?php echo base_url() ?>">
                                <i class="icon-shouye_xiala"></i><span style="color:#ffffff;">首页</span>
                            </a>
                        </li>
                        <li>
                            <a title="个人中心" href="<?php echo base_url('mine') ?>">
                                <i class="icon-wode-2"></i><span style="color:#ffffff;">我的</span>
                            </a>
                        </li>
...
$('#biz_search').keydown(function(event){
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(res){
                                            ...
                                            $('.zonghe').on('click',function(){
                                                        $.ajax({
                                                        url : api_item_index,
                                                        data : {app_type:'client',limit:10,offset:0,name:$('#biz_search').val()},
                                                        success : function(res){
                                                            $('#bizDetailList').html('');
                                            ...
                                            // 按照销量排行
                                                    ...
                                                    $('.xiaoliang').on('click',function(){
                                                        ...
                                                        shopClass = $(this).text();
                                                            if(sold_overall == 0){
                                                                $.ajax({
                                                                url : api_item_index,
                                                                data : {app_type:'client',limit:10,orderby_sold_overall:'DESC',name:$('#biz_search').val()},
                                                                success : function(res){
                                                                    $('#bizDetailList').html('');
                                                    ...
                                                    $('.shangxin').on('click',function(){
                                                        ...
                                                        page = 0;
                                                            if(time_publish == 0){
                                                                $.ajax({
                                                                url : api_item_index,
                                                                data : {app_type:'client',limit:10,orderby_time_publish:'DESC',name:$('#biz_search').val()},
                                                                success : function(res){
                                                    ...
                                                    $('.price_finish').on('click',function(){
                                                        ...
                                                        $.ajax({
                                                            url : api_item_index,
                                                            data : {app_type:'client',limit:10,price_min:$('.price_min').val(),price_max:$('.price_max').val(),name:$('#biz_search').val()},
                                                            success : function(res){
                                                                $('#bizDetailList').html('');
                                                                var con = res.content;
                                                                for (var i = 0;i < con.length;i++) {
                                                ...
                                                $('.xia').css('color','#999');
                                                    if(by_price == 0){
                                                        $.ajax({
                                                        url : api_item_index,
                                                        data : {app_type:'client',limit:10,orderby_price:'DESC',name:$('#biz_search').val()},
                                                        success : function(res){
                                            ...
                                            +'"><h1>'+con[i].name+'</h1><p><span>¥'+con[i].price+'</span></p></a></li>';
                                                    ...
                                                    by_price = 1;
                                                        ...
                                                        $.ajax({
                                                        url : api_item_index,
                                                        data : {app_type:'client',limit:10,orderby_price:'ASC',name:$('#biz_search').val()},
                                                        success : function(res){
...
//                  });
                    ...
                    $.ajax({
                        url:api_item_index,
                        async:false,
                        data:{app_type:'client',offset:0,name:$(this).val()},
                        success:function(res){
                            $('#bizDetailList').html('');
                            var con = res.content;
                            console.log(con);
