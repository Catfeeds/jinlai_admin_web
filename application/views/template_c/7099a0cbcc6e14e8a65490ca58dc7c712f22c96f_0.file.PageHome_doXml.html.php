...
function content_5b8f4acb4b0841_94352455 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/backend/PageHome/updateredis" class="form-horizontal" id="updateform" role="form" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
            <div class="col-md-offset-3 col-md-9">
                 <button class="btn btn-app btn-warning" type="button" onclick="updatehomepage()" >
                                            <i class="ace-icon fa fa-undo bigger-230"></i>
                                            更新首页
                                        </button>  </div>
                </br>
    ...
    <div class="col-xs-12">
        ...
        <form action="/backend/PageHome/detail" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <select class="form-control" id="form-field-select-1" name="classtype">
                ...
                <option value="834">学习教育</option>           
                <option value="510">休闲娱乐</option>           
                <option value="513">时尚丽人</option>           
                <option value="515">宠物服务</option>           
                <option value="516">旅游名宿</option>           
                <option value="512">运动健康</option>           
                <option value="514">婚纱摄影</option>           
                <option value="517">汽车管家</option> 
                <option value="511">特色美食</option> 
                <option value="518">私人定制</option> 

                <option value="15">分类测试</option>           
...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/backend/PageHome/updatedetail" class="form-horizontal" id="updateclassform" role="form" method="post" enctype="multipart/form-data">
            <label for="form-field-select-1">选择分类</label>
            <select class="form-control" id="form-field-select-1" name="classtype">
                <option value="2">生鲜超市</option>
                <option value="15">潮流酷玩</option>
          ...
          <div class="form-group">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
            <div class="col-md-offset-3 col-md-9">
                 <button class="btn btn-app btn-purple btn-sm" type="button" onclick="updateclasspage()" >
                                            <i class="ace-icon fa fa-undo bigger-230"></i>
                                            更新分类页
                                        </button>  </div>
                </br>
