<?php
	...
	{	
		...
		protected $names_to_sort = array(
			'vote_id', 'tag_id', 'index_id', 'name', 'description', 'url_image', 'ballot_overall', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id', 'status', 'time_create_min', 'time_create_max',
		);
