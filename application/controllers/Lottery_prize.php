<?php
	...
	{	
		...
		protected $names_to_sort = array(
			'prize_id', 'lottery_id', 'index_id', 'name', 'description', 'url_image', 'rate', 'stock', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id', 'status',  'sth_min', 'sth_max',
		);
		...
		protected $names_edit_allowed = array(
			'prize_id', 'lottery_id', 'index_id', 'name', 'description', 'url_image', 'rate', 'stock', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id', 'status', 
		);
		...
		public function __construct()
		{
			...
			$this->class_name_cn = '抽奖奖项'; // 改这里……
			$this->table_name = 'lottery_prize'; // 和这里……
			$this->id_name = 'prize_id'; // 还有这里，OK，这就可以了
...
// 			$this->basic->permission_check($role_allowed, $min_level);
			...
			$this->form_validation->set_rules('stock', '奖品总数', 'trim|');
