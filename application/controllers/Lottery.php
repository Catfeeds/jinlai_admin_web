<?php
	...
	{	
		...
		protected $names_to_sort = array(
			'lottery_id', 'name', 'url_name', 'description', 'extra', 'url_image', 'url_audio', 'url_video', 'url_video_thumb', 'max_user_total', 'max_user_daily', 'chance_shared_daily', 'exturl_before', 'exturl_ongoing', 'exturl_after', 'content_css', 'time_start', 'time_end', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id',  'sth_min', 'sth_max',
		);
		...
		public function __construct()
		{
			...
			$this->class_name_cn = '抽奖'; // 改这里……
			$this->table_name = 'lottery'; // 和这里……
			$this->id_name = 'lottery_id'; // 还有这里，OK，这就可以了
