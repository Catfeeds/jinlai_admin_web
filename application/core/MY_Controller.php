...
// 			$this->basic->permission_check($role_allowed, $min_level);
        ...
        // 获取商品列表
        protected function list_ornament_biz($params = NULL)
        {
            // 默认获取未删除项
            if ( empty($params) ) $params['time_delete'] = 'NULL';
            ...
            return ($result['status'] === 200)? $result['content']: NULL;
        } // end list_ornament_biz

        // 获取特定商品信息
        protected function get_ornament_biz($id)
        {
            $params['id'] = $id;
